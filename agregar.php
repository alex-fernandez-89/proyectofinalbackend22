<?php
  ...
  $consulta = "INSERT INTO obra_de_arte (id,tipo_de_arte,medida,tecnica,material,acabado,precio,imagen)
          VALUES ('','$tipo_arte','$medida','$tecnica','$material','$acabado','$precio','$imagen')";
